...
export default function Footer() {
    return (
        <footer className="bg-blue-900 text-white w-full py-8 mt-10">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between mb-6 space-y-8 md:space-y-0">
                    <div>
                    ...
                    <div>
                        ...
                        <p className="mt-4">Endereço: Rua Exemplo, 123 - Cidade, Estado</p>
                        <p>Email: contato@exemplo.com</p>
                        <p>Telefone: (11) 1234-5678</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold">Newsletter</h4>
                        <p className="mt-4">Inscreva-se para receber novidades.</p>
